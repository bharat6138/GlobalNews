...
export default function NewsCard(Props) {
	let { newsTitle, imgUrl, readMore, author, date, sorcename } = Props;
	return (
		<>
			<div className="card card-blur-lg">
				...
				<div className="card-body">
					<h5 className="card-title d-inline-block news-desc ">{newsTitle}</h5>
					...
					<a href={readMore} className="btn btn-sm btn-dark">
						Read More
					</a>
				</div>
			</div>
